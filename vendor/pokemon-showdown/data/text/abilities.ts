export const AbilitiesText: { [id: IDEntry]: AbilityText } = {
	...
	eelevate: {
		name: "Eelevate",
		desc: "This Pokemon is immune to Ground-type moves and entry hazards. Its highest stat is raised by 1 stage if it attacks and knocks out another Pokemon.",
		shortDesc: "Ground immunity; after KOing a Pokemon: raises highest stat by 1.",
	},
	electricsurge: {
		name: "Electric Surge",
	...
	firemane: {
		name: "Fire Mane",
		desc: "This Pokemon's Fire-type attacks have their power multiplied by 1.5.",
