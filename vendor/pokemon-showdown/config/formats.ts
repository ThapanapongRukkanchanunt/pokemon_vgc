...
const CHAMPIONS_REG_MB_UNBANLIST = [
	'Raichu-Mega-X', 'Raichu-Mega-Y', 'Vileplume', 'Qwilfish',
	'Sceptile', 'Sceptile-Mega', 'Blaziken', 'Blaziken-Mega', 'Swampert', 'Swampert-Mega',
	'Mawile', 'Mawile-Mega', 'Metagross', 'Metagross-Mega', 'Staraptor', 'Staraptor-Mega',
	'Musharna', 'Scolipede', 'Scolipede-Mega', 'Scrafty', 'Scrafty-Mega',
	'Eelektross', 'Eelektross-Mega', 'Pyroar', 'Pyroar-Mega',
	'Malamar', 'Malamar-Mega', 'Barbaracle', 'Barbaracle-Mega',
	'Dragalge', 'Dragalge-Mega', 'Grimmsnarl', 'Falinks', 'Falinks-Mega',
	'Overqwil', 'Houndstone', 'Annihilape', 'Gholdengo',

	'Barbaracite', 'Big Root', 'Blazikenite', 'Damp Rock', 'Dragalgite',
	'Eelektrossite', 'Expert Belt', 'Falinksite', 'Heat Rock', 'Icy Rock',
	'Iron Ball', 'Life Orb', 'Light Clay', 'Malamarite', 'Mawilite',
	'Metagrossite', 'item: Metronome', 'Muscle Band', 'Pyroarite',
	'Raichunite X', 'Raichunite Y', 'Sceptilite', 'Scolipite', 'Scraftinite',
	'Shed Shell', 'Smooth Rock', 'Staraptite', 'Swampertite', 'Wide Lens',
...
export const Formats: import('../sim/dex-formats').FormatList = [
	...
	},
	{
		...
		bestOfDefault: true,
		ruleset: ['Flat Rules', 'VGC Timer'],
		unbanlist: CHAMPIONS_REG_MB_UNBANLIST,
	},
	{
